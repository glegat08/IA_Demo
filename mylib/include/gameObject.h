...
public:
    ...
    virtual bool isAlive() const = 0;            // Check if the object is alive
    virtual bool isShooting() const = 0;         // Check if the object is shooting
    virtual bool isAttacking() const = 0;        // Check if the object is attacking
    virtual bool isInvulnerable() const = 0;     // Check if the object is invulnerable
    ...
    virtual int getHp() const = 0;               // Return health points
    virtual int getShield() const = 0;           // Return shield points
